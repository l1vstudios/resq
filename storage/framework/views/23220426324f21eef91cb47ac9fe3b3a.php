<?php $__env->startSection('title'); ?> RedNode Pin Scan <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> RedNode Pin Scan <?php $__env->endSlot(); ?>
    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-body">
                ...
                <form id="rednode-pin-scan-form" action="<?php echo e(route('rednode-pin-scan.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <label class="form-label pin-scan-label">Data Logger</label>
                        <select class="form-select" id="pin-scan-logger-select">
                            <option value="<?php echo e($rednodeLoggerCode); ?>">Pakai kode aktif</option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $dataLoggers->whereNotNull('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logger): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($logger['id']); ?>" <?php if(($logger['id'] ?? null) === $rednodeLoggerCode): echo 'selected'; endif; ?>>
                                    <?php echo e($logger['id']); ?> - <?php echo e($logger['device_label'] ?? 'RedNode'); ?><?php echo e(! empty($logger['remote_host']) ? ' / ' . $logger['remote_host'] : ''); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pin-scan-logger-code" value="<?php echo e($rednodeLoggerCode); ?>" required>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" class="form-control" id="pin-scan-baud-rate" value="<?php echo e($rednodeSerialConfig['baud_rate'] ?? env('REDNODE_BAUD_RATE', 9600)); ?>" min="300" required>
                        </div>
                        <div class="col-6 mb-3">
                            <label class="form-label pin-scan-label">Timeout RX</label>
                            <input type="number" class="form-control" id="pin-scan-response-timeout" value="<?php echo e(env('REDNODE_SCAN_RESPONSE_TIMEOUT_MS', 300)); ?>" min="100" max="5000" required>
                        </div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label pin-scan-label">Delay Slave</label>
                        <input type="number" class="form-control" id="pin-scan-delay" value="<?php echo e(env('REDNODE_SCAN_DELAY_MS', 80)); ?>" min="0" max="5000" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-grid gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ttyOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <label class="pin-scan-port-option d-flex align-items-start gap-2 mb-0" for="pin-scan-port-<?php echo e($loop->index); ?>">
                                    <input
                                        class="form-check-input mt-1"
                                        type="checkbox"
                                        id="pin-scan-port-<?php echo e($loop->index); ?>"
                                        value="<?php echo e($option['port']); ?>"
                                        data-pin-scan-port
                                        checked
                                    >
                                    <span>
                                        <span class="fw-bold d-block"><?php echo e($option['pins']); ?> - <?php echo e($option['port']); ?></span>
                                        <span class="text-muted small"><?php echo e($option['mapping']); ?></span>
                                    </span>
                                </label>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/brainsoft/kerjaan/resq/resources/views/modules/rednode-pin-scan/index.blade.php ENDPATH**/ ?>