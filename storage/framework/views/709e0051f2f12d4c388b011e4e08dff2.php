...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        var mapEl = document.getElementById(<?php echo json_encode($mapId, 15, 512) ?>);
        var points = <?php echo json_encode($points, 15, 512) ?>;
        var lines = <?php echo json_encode($lines, 15, 512) ?>;
        var mapStyle = <?php echo json_encode($mapStyle, 15, 512) ?>;
...
<?php /**PATH /Users/brainsoft/kerjaan/resq/resources/views/modules/platform-operations/partials/map-script.blade.php ENDPATH**/ ?>