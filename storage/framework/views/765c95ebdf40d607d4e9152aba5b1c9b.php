...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var initialAlertActive = <?php echo json_encode($dashboardAlertActive ?? false, 15, 512) ?>;
        var mapDataUrl = <?php echo json_encode(route('dashboard.map-data', [], false)) ?>;
        var sirenAudio = new Audio(<?php echo json_encode('/sound/sirene.mp3', 15, 512) ?>);
