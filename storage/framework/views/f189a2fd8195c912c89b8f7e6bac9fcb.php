<?php $__env->startSection('title'); ?> Station Integrity <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> Operational Integrity <?php $__env->endSlot(); ?>
    ...
    <div class="card-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
            ...
            <div class="ops-filter-row">
                <a href="<?php echo e(route('platform-operations.integrity.index')); ?>" class="btn btn-sm <?php echo e(empty($activeFilter) ? 'btn-primary' : 'btn-outline-primary'); ?>">All</a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="<?php echo e(route('platform-operations.integrity.index', ['status' => $filter])); ?>" class="btn btn-sm <?php echo e($activeFilter === $filter ? 'btn-primary' : 'btn-outline-primary'); ?>"><?php echo e($filter); ?></a>
            ...
            <table class="table table-nowrap align-middle ops-table mb-0">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $stations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td>
                                <a href="<?php echo e(route('platform-operations.stations.show', [$row['station']['id'], 'tab' => 'integrity'])); ?>" class="fw-semibold">
                            ...
                            <td><?php echo $__env->make('modules.platform-operations.partials.status-badge', ['status' => $row['integrity']['overall'] ?? 'Warning'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></td>
                            <td><?php echo e($row['integrity']['components']['connectivity']['status'] ?? '-'); ?></td>
                            <td><?php echo e($row['integrity']['components']['telemetry_data_health']['status'] ?? '-'); ?></td>
                            <td><?php echo e(! empty($row['integrity']['last_seen_at']) ? \Illuminate\Support\Carbon::parse($row['integrity']['last_seen_at'])->diffForHumans() : '-'); ?></td>
                        </tr>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/brainsoft/kerjaan/resq/resources/views/modules/platform-operations/integrity.blade.php ENDPATH**/ ?>